...
> **Amendment (2026-08-20):** Project relocated to dedicated monorepo `ahooTech/project-zuri-pulse` (main + develop, PR-only policy per 1.3 §2). The row above remains as the assessed baseline evidence.
